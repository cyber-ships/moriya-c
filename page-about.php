      ...
      <section class="page_heading about">
        <div class="inner">
          <h1>
            ...
            <picture>
              <img src="<?php echo esc_url(get_theme_file_uri('/img/about/heading_img.png')); ?>" alt="企業情報" />
            </picture>
          </h1>
        </div>
      </section>
        ...
        <div class="inner">
          ...
          <div class="about_number">
            <a href="#reason_1" class="about_number_item">
              ...
              <img src="<?php echo esc_url(get_theme_file_uri('/img/about/arw.png')); ?>" alt="" />
            </a>
            ...
            <a href="#reason_6" class="about_number_item">
              ...
              <div class="about_number_item_copy">
                <span>全国52箇所</span>の<br />サービスステーション<br
                  class="sp"
        ...
        <div class="inner">
          <div class="block_type_01">
            <div id="reason_1" class="block anchor">
              <div class="block-img">
                <picture>
                  <img src="<?php echo esc_url(get_theme_file_uri('/img/about/about_reason_1.jpg')); ?>" alt="" />
                </picture>
              </div>
              <div class="block-cnt">
            ...
            <div id="reason_2" class="block anchor">
              <div class="block-img">
                <picture>
                  <img src="<?php echo esc_url(get_theme_file_uri('/img/about/about_reason_2.jpg')); ?>" alt="" />
                </picture>
              </div>
              <div class="block-cnt">
                <div class="num">理由<em>2</em></div>
                <h2 class="ttl">
                  「ご希望のエレベーター」<br /><span>カスタマイズ可能</span>
                </h2>
                <p>
            ...
            <div id="reason_3" class="block anchor">
              <div class="block-img">
                <picture>
                  <img src="<?php echo esc_url(get_theme_file_uri('/img/about/about_reason_3.jpg')); ?>" alt="" />
                </picture>
              </div>
              <div class="block-cnt">
            ...
            <div id="reason_4" class="block anchor">
              <div class="block-img">
                <picture>
                  <img src="<?php echo esc_url(get_theme_file_uri('/img/about/about_reason_4.jpg')); ?>" alt="" />
                </picture>
              </div>
              <div class="block-cnt">
                <div class="num">理由<em>4</em></div>
                <h2 class="ttl">
                  オリジナル垂直自動搬送期<br /><span>「マックリフター」</span>
                </h2>
                <p>
            ...
            <div id="reason_5" class="block anchor">
              <div class="block-img">
                <picture>
                  <img src="<?php echo esc_url(get_theme_file_uri('/img/about/about_reason_5.jpg')); ?>" alt="" />
                </picture>
              </div>
              <div class="block-cnt">
            ...
            <div id="reason_6" class="block anchor">
              <div class="block-img">
                <picture>
                  <img src="<?php echo esc_url(get_theme_file_uri('/img/about/about_reason_6.jpg')); ?>" alt="" />
                </picture>
              </div>
              <div class="block-cnt">
                <div class="num">理由<em>6</em></div>
                <h2 class="ttl">
                  <span>全国52箇所の</span><br />
                  サービスステーションによる<br /><span
                    >24時間365日のサービス対応</span
                  >
                </h2>
                <p>
                  全国52ヶ所にサービスステーションを設置。細やかな保守と万が一の故障時には迅速な対応が可能です。故障時は365日24時間対応の本社サービス情報センターで受付、速やかにサービスステーションまたは巡回中のサービスマンを現地へ派遣いたします。
                </p>
              </div>
            </div>
          </div>
